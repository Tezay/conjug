...
The frontend is built with React. To start the development server, navigate to the `Frontend` directory and run:
...
The backend is built with Flask. To start the development server, run:
