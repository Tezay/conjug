            ...
            <div className="drawer-side z-50">
                ...
                <aside className="min-h-full w-80 bg-base-100 text-base-content">
                    ...
                    <ul className="menu p-4 w-full text-base-content">
                        <li>
                            <Link to="/it" className="text-lg py-3">
                                <span>🇮🇹</span> Italien
                            </Link>
                        </li>
                        <li>
                            <Link to="/es" className="text-lg py-3">
                                <span>🇪🇸</span> Espagnol
                            </Link>
                        </li>
                        <li>
                            <Link to="/leaderboard" className="text-lg py-3">
                        ...
                        {isLoading ? (
                            ...
                            <li>
                                <Link to="/profile" className="text-lg py-3">
                            ...
                            <>
                                <li>
                                    <Link to="/login" className="text-lg py-3">
                                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <li>
                                    <Link to="/register" className="text-lg py-3">
                                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
