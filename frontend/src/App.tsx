            ...
            <div className="drawer-side z-50">
                ...
                <aside className="min-h-full w-80 bg-base-100 text-base-content">
                    ...
                    <div className="flex items-center justify-between p-4 border-b border-base-300">
                        <span className="text-xl font-bold text-primary">Conjug.fr</span>
                    ...
                    <ul className="menu p-4 w-full text-base-content">
                        <li>
                            <label htmlFor="mobile-drawer">
                                <a href="/it" className="text-lg py-3">
                                    <span>🇮🇹</span> Italien
                                </a>
                            </label>
                        </li>
                        <li>
                            <label htmlFor="mobile-drawer">
                                <a href="/es" className="text-lg py-3">
                                    <span>🇪🇸</span> Espagnol
                                </a>
                            </label>
                        </li>
                        ...
                        <li>
                            <label htmlFor="mobile-drawer">
                                <a href="/login" className="text-lg py-3">
                        ...
                        <li>
                            <label htmlFor="mobile-drawer">
                                <a href="/register" className="text-lg py-3">
                                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <li>
                            <label htmlFor="mobile-drawer">
                                <a href="/profile" className="text-lg py-3">
                                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <li>
                            <label htmlFor="mobile-drawer">
                                <a href="/leaderboard" className="text-lg py-3">
                                    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
